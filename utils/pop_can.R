# Update quarterly population values in geo/can.csv #
# Author: Jean-Paul R. Soucy #

# Note: This script assumes the working directory is set to the root directory of the project.
# This is most easily achieved by using the provided CovidTimelineCanada.Rproj in RStudio.

# load can.csv and remove existing pop columns
can <- utils::read.csv("geo/can.csv") |>
  dplyr::select(
    "region",
    "pruid",
    "name_canonical",
...
# save updated can.csv
utils::write.csv(can, "geo/can.csv", row.names = FALSE, na = "")
